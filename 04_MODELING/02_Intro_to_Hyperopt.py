...
# Define which algorithm to optimise. In this case, we will use the suggest, that is bayesian
algorithm = tpe.suggest
# Define the Spark Trials. This will be used to parallelize the optimisaiton.
...
with mlflow.start_run(run_name=RUN_NAME):
    best_params = fmin(
        ...
        max_evals=model_config['MAX_EVALS'], # Max number of iterations
