...
# Where are you working? Repos or Users?
workspace = 'Users'
# Adapt your workspace here - Repos or Workspace + email
# Get the experiment IDs
experiments_notebook = mlflow.get_experiment_by_name(f'/{workspace}/{user}/artefact_mlflow_training/04_MODELING/02_Intro_to_Hyperopt')
